...
class ChromeBrowser:
	...
	def get_collections(self):
		return [Collection(collection) for collection in self.browser.find_elements_by_class_name(constants.collection_class_name)]
	...
	def get_problems(self):
		return [Problem(problem) for problem in self.browser.find_elements_by_class_name(constants.problem_class_name)]
